...
#ifndef _MODELAFFINE_H_
#define _MODELAFFINE_H_

#include <libdirac_motionest/model_global_motion.h>

namespace dirac
{
    //! Class to model global motion using affine transform
    class ModelAffine : public ModelGlobalMotion
    {
    public :
        //! Constructor
        ModelAffine(const MEData &,
                    const EncoderParams &);
        ...
        /*!
            Calculates affine model parameters using
            integer motion vectors and inliers array
        */
        void CalculateModelParameters(const MvArray &, TwoDArray<int> &, OneDArray<float> &);
    
        /*!
            Calculates affine model parameters using
            float motion vectors and inliers array
        */
